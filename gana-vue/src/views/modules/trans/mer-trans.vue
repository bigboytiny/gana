  ...
  <div class="mod-log">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="商户号">
        <el-input v-model="dataForm.mchId" placeholder="商户号" clearable></el-input>
      </el-form-item>
    ...
    <el-table
      ...
      <el-table-column align="center">
        ...
        <el-table-column prop="mchId" header-align="center" align="center" width="150" label="商户号"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/trans/trans/agentList'),
          method: 'get',
