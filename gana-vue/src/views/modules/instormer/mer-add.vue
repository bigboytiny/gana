<template>
  <div class="mer-add">
    ...
    <el-form :model="ruleForm" :rules="dataRules" ref="ruleForm" class="form-column" :inline="true">
              ...
              <el-row>
                <el-col class="form-group col-md-4">
                  <el-form-item label="商户类型" prop="merchClass" required>
                    <el-radio-group v-model="ruleForm.merchClass">
                      <el-radio label="C">企业</el-radio>
                      <el-radio label="P">个体</el-radio>
                    </el-radio-group>
                  </el-form-item>
                </el-col>
                ...
                <el-col class="form-group col-md-4">
                  <el-form-item label="商户性质" prop="merchType" required>
                    <el-select
                      class="form-control"
                      v-model="ruleForm.merchType"
                      placeholder="请选择商户性质"
                    >
                      <el-option label="连锁" value="1"></el-option>
                      <el-option label="单店" value="2"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row v-if="ruleForm.merchClass == 'C'">
                <el-col class="form-group col-md-4">
                  <el-form-item label="是否三证合一" prop="isCodeUnion" required>
                    <el-radio-group v-model="ruleForm.isCodeUnion">
              ...
              <el-row v-if="ruleForm.merchClass == 'C'">
                <el-col class="form-group col-md-4">
                  <el-form-item label="营业执照有效期类型" prop="licType" required>
                    <el-radio-group v-model="ruleForm.licType">
              ...
              <el-row v-if="ruleForm.merchClass == 'C'">
                ...
                <el-col class="form-group col-md-4">
                  <el-form-item label="法人证件类型" prop="idType" required>
                    <el-select class="form-control" v-model="ruleForm.idType" placeholder="请选择证件类型">
              ...
              <el-row v-if="ruleForm.merchClass == 'C'">
                <el-col class="form-group col-md-4">
                  <el-form-item label="法人证件有效期类型" prop="idValidType" required>
                    <el-radio-group v-model="ruleForm.idValidType">
                      <el-radio label="0">非长期</el-radio>
                      <el-radio label="1">长期</el-radio>
                    </el-radio-group>
                  </el-form-item>
              ...
              <el-row>
                <el-col class="form-group col-md-4">
                  <el-form-item label="联系人有效期类型" prop="cidValidType" required>
                    <el-radio-group v-model="ruleForm.cidValidType">
                      <el-radio label="0">非长期</el-radio>
                      <el-radio label="1">长期</el-radio>
                    </el-radio-group>
                  </el-form-item>
          ...
          <el-row>
            <el-col class="form-group col-md-4">
              <el-form-item label="结算周期" prop="settleTerm" required>
                <el-select class="form-control" v-model="ruleForm.settleTerm" placeholder="请选择结算周期">
                  <el-option label="T1" value="1"></el-option>
                  <el-option label="D1" value="2"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col class="form-group col-md-4">
              <el-form-item label="结算人证件类型" prop="bankIdType" required>
                <el-select
                  class="form-control"
                  v-model="ruleForm.bankIdType"
                  placeholder="请选择结算人证件类型"
                >
                  <el-option label="身份证" value="1"></el-option>
          ...
          <el-row>
            <el-col class="form-group col-md-4">
              <el-form-item label="结算人证件有效期类型" prop="bankActIdValidType" required>
                <el-radio-group v-model="ruleForm.bankActIdValidType">
                  <el-radio label="0">非长期</el-radio>
                  <el-radio label="1">长期</el-radio>
                </el-radio-group>
              </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      dataRules: {
        ...
        bankPhone: [
          { required: true, message: '结算人手机号不能为空', trigger: 'blur' },
          { validator: validateMobile, trigger: 'blur' }
        ],
        bankActId: [
  ...
  methods: {
    ...
    next() {
      if (this.active === 3){
        ...
        if(this.isLoad){
          ...
          this.$http({
              method:'post',
              url:this.$http.adornUrl(`/instormer/mer/upload`),
              data:this.formDate,
    ...
    submitForm() {
      this.$refs['ruleForm'].validate((valid) => {
        ...
        if (valid) {
          this.$http({
            url: this.$http.adornUrl(`/instormer/mer/save`),
            method: "post",
